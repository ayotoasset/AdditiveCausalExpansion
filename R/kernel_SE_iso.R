KernelClass_SE_iso <- setRefClass("SqExpIsoKernel",
                              ...
                              methods = list(
                                ...
                                kernel_mat = function(X1,X2,Z1,Z2) {
                                  ...
                                  Klist <- kernmat_SE_iso_cpp(X1,X2,Z1,Z2,parameters) #lambda and L

                                },
                                kernel_mat_sym = function(X,Z) {
                                  #intended use for the gradient step
                                  Klist <- kernmat_SE_iso_symmetric_cpp(X,Z,parameters)
                                  Kmat <<- Klist$full
