KernelClass_Matern52 <- setRefClass("Matern52",
                              ...
                              methods = list(
                                ...
                                kernel_mat = function(X1,X2,Z1,Z2) {
                                  ...
                                  Klist <- kernmat_Matern52_cpp(X1,X2,Z1,Z2,parameters) #lambda and L

                                },
                                kernel_mat_sym = function(X,Z) {
                                  #intended use for the gradient step
                                  Klist <- kernmat_Matern52_symmetric_cpp(X,Z,parameters)
                                  Kmat <<- Klist$full
                                ...
                                para_update = function(iter,y,X,Z,Optim,printevery=100) {
                                  ...
                                  gradients <- grad_Matern_cpp(y,X,Z,Kmat,Karray,invKmatn,invKmatList$eigenval,parameters,stats,B,2)
