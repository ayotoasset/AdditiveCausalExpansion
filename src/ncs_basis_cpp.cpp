...
arma::mat generate_ncs_matrix(arma::colvec x, arma::vec knots) {
...
arma::mat generate_ncs_derivative_matrix(arma::colvec x, arma::vec knots) {
...
arma::mat ncs_basis(arma::colvec x, arma::vec knots) {
  ...
  // assign dimensions:
  design.col(0) = x;
  design.submat(0, 1, n - 1, B - 1) = generate_ncs_matrix(x, knots);
  return design;
}
...
arma::mat ncs_basis_deriv(arma::colvec x,arma::vec knots) {
  ...
  design.submat(0, 1, n - 1, B - 1) = generate_ncs_derivative_matrix(x, knots);
